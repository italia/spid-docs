...
L'abiente di test è disponibile in [docker](https://github.com/italia/spid-testenv-docker) e su [https://idp.spid.gov.it:9443](https://idp.spid.gov.it:9443) (identity server) e [http://idp.spid.gov.it:8080](http://idp.spid.gov.it:8080) (backoffice). Il sistema, in questa prima fase, è totalmente aperto, si chiede, quindi di avere rispetto e non cancellare dati se non di propria "proprietà".
...
[https://github.com/italia/spid-testenv-docker](https://github.com/italia/spid-testenv-docker)
